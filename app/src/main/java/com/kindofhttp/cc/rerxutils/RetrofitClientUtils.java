...
public class RetrofitClientUtils {
    ...
    private static class SingletonHolder {
        private static RetrofitClientUtils INSTANCE = new RetrofitClientUtils(
                mContext);
    }
    ...
    private RetrofitClientUtils(Context context, String url, Map<String, String> headers) {
...
//                .addNetworkInterceptor(new CaheInterceptor(context))
    ...
    public Subscription json(String url, RequestBody jsonStr, Subscriber<UserInfo> subscriber) {
    ...
    public <T> Observable.Transformer<BaseResponseEntity<T>, T> transformer() {
